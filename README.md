...
- Классификация товара по справочнику: `brand -> model_family -> model_variant`.
...
2. Проверить, что в `brands`/`model_families` есть нужные канонические записи (базовый seed заполняется автоматически).
